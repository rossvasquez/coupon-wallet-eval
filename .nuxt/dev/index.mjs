globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/rossv/Desktop/coupon-wallet-eval/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabase": {
      "url": "https://uqjrkgdwnsoeohmpxcjf.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVxanJrZ2R3bnNvZW9obXB4Y2pmIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODQyMTI2MzksImV4cCI6MTk5OTc4ODYzOX0.lSP_XA64CjFonZbiBwRtxojV_CPzQCc8kSBSVHzJQzM",
      "client": {},
      "redirect": {
        "login": "/",
        "callback": "/wallet"
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/rossv/Desktop/coupon-wallet-eval/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\rossv\\Desktop\\coupon-wallet-eval","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\rossv\\Desktop\\coupon-wallet-eval\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\rossv\\Desktop\\coupon-wallet-eval\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\rossv\\Desktop\\coupon-wallet-eval\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _pz9yAa = defineEventHandler(async (event) => {
...
const _lazy_7m1iNJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_7m1iNJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _pz9yAa, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_7m1iNJ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/rossv/Desktop/coupon-wallet-eval/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/rossv/Desktop/coupon-wallet-eval/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
